...
size = [256, 512, 1024, 512, 256, 64, 32, FLAGS.num_of_groups]
...
hypothesis = simple_layer("7", input_tensor=L6, input_size=size[6], output_size=size[7], relu=False, dropout=False, keep_prob=keep_prob)