...
size = [256, 512, 1024, 1024, 512, 256, 128, 64, 32, 10, FLAGS.num_of_groups]
...
hypothesis = simple_layer("10", input_tensor=L9, input_size=size[9], output_size=size[10], relu=False, dropout=False, keep_prob=keep_prob)