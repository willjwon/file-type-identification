...
def main():
    ...
    def file_type_and_accuracy(result):
        ...
        return file_type, tf.reduce_sum(tf.cast(tf.equal(result, tf.argmax(neural_net.Y, 1)), tf.float32))
    ...
    with tf.Session() as sess:
        ...
        for step in range(current_step, FLAGS.num_of_total_global_steps + 1):
            ...
            if step % FLAGS.checkpoint_steps == 0:
                ...
                print_accuracy(accuracy_table, num_of_validation_files, test_type="validation")
        ...
        print_accuracy(accuracy_table, num_of_test_files, test_type="test")
