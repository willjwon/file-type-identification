...
L4 = simple_layer("4", input_tensor=L3, input_size=128, output_size=64, relu=True, dropout=True, keep_prob=keep_prob)
L5 = simple_layer("5", input_tensor=L4, input_size=64, output_size=32, relu=True, dropout=True, keep_prob=keep_prob)
hypothesis = simple_layer("6", input_tensor=L5, input_size=32, output_size=FLAGS.num_of_groups,
