...
L4 = cnn_layer("4", input_tensor=L3, filter_size=[3, 3], channel_size=[64, 128], relu=True, pool_size=[1, 1])
L5 = reshape_layer("5", input_tensor=L4, shape=[-1, 4 * 4 * 128])
L6 = simple_layer("6", input_tensor=L5, input_size=4 * 4 * 128, output_size=256,
                  relu=True, dropout=True, keep_prob=keep_prob)
hypothesis = simple_layer("7", input_tensor=L6, input_size=256, output_size=FLAGS.num_of_groups,
