...
size = [256, 512, 800, 1024, 1024, 800, 512, 256, 128, 64, 32, 10, FLAGS.num_of_groups]
...
L8 = simple_layer("8", input_tensor=L7, input_size=size[7], output_size=size[8], relu=True, dropout=True, keep_prob=keep_prob)
L9 = simple_layer("9", input_tensor=L8, input_size=size[8], output_size=size[9], relu=True, dropout=True, keep_prob=keep_prob)
L10 = simple_layer("10", input_tensor=L9, input_size=size[9], output_size=size[10], relu=True, dropout=True, keep_prob=keep_prob)
L11 = simple_layer("11", input_tensor=L10, input_size=size[10], output_size=size[11], relu=True, dropout=True, keep_prob=keep_prob)
hypothesis = simple_layer("12", input_tensor=L11, input_size=size[11], output_size=size[12], relu=False, dropout=False, keep_prob=keep_prob)